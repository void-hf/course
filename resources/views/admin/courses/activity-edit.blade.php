...
<div class="page-content-wrap clearfix">
    <div class="page-content-wrap">
        <form class="layui-form">
            ...
            <input type="hidden" name="addFilelist"  value="{{$activity->enclosure}}">
            <input type="hidden" name="activity_img" value="{{$activity->activity_img}}">
            <input type="hidden" name="start_time"   value="{{$activity->start_time}}">
            <input type="hidden" name="end_time"     value="{{$activity->end_time}}">
            <input type="hidden" name="activity_des" value="{{$activity->activity_des}}">
                    ...
                    <div class="layui-tab-item layui-show">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                ...
                                <input type="text" name="activity_name" required lay-verify="required" placeholder="请输入活动标题"
                                       autocomplete="off" class="layui-input" value="{{$activity->activity_name}}">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="up_user_name" required lay-verify="required" placeholder="请输入活动负责人名"
                                       autocomplete="off" class="layui-input" value="{{$activity->up_user_name}}">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="phone" required lay-verify="required" placeholder="请输入联系方式"
                                       autocomplete="off" class="layui-input" value="{{$activity->phone}}">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="activity_address" required lay-verify="required" placeholder="请输入活动的地址"
                                       autocomplete="off" class="layui-input"  value="{{$activity->activity_address}}">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" id="start_time" placeholder="请选择开始时间">
                            </div>

                            <label class="layui-form-label">活动结束时间</label>
                            <div class="layui-input-inline">
                                <input type="text" id="end_time" class="layui-input" placeholder="请选择结束时间">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text"  class="layui-input" id="l_num" placeholder="经度" disabled value="{{$activity->lat}}">
                            </div>
                            <div class="layui-input-inline">
                                <input type="text"  class="layui-input" id="n_num" placeholder="纬度" disabled value="{{$activity->lng}}">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="checkbox" name="label[1]" title="周一" @if(isset($activity->repetition['1']))
                                checked="" @endif >
                                <input type="checkbox" name="label[2]" title="周二" @if(isset($activity->repetition['2']))
                                checked="" @endif >
                                <input type="checkbox" name="label[3]" title="周三" @if(isset($activity->repetition['3']))
                                checked="" @endif>
                                <input type="checkbox" name="label[4]" title="周四" @if(isset($activity->repetition['4']))
                                checked="" @endif >
                                <input type="checkbox" name="label[5]" title="周五" @if(isset($activity->repetition['5']))
                                checked="" @endif >
                                <input type="checkbox" name="label[6]" title="周六" @if(isset($activity->repetition['6']))
                                checked="" @endif >
                                <input type="checkbox" name="label[7]" title="周日" @if(isset($activity->repetition['7']))
                                checked="" @endif >
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-upload-drag" id="bannerUpload" style="background-image: url('{{$activity->activity_img}}')">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="checkbox" name="is_open" lay-skin="switch" lay-filter="switchTest" lay-text="ON|OFF" @if ($activity->is_open=== 1) checked="" @endif>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                ...
                                <input type="radio" name="category_id" value="{{$cate->id}}" title="{{$cate->category_name}}" @if ($cate->id=== $activity->category_id) checked="" @endif>
                                @endforeach
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="checkbox" name="is_real_name_registration"lay-skin="switch" lay-filter="switchTest" lay-text="ON|OFF" @if ($activity->is_real_name_registration=== 1) checked="" @endif>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <textarea class="layui-textarea layui-hide" lay-verify="content" id="content">{{$activity->activity_des}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <textarea class="layui-textarea" name="material" placeholder="请输入内容">{{$activity->material}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="sign_up_ple_max" required lay-verify="required" placeholder="请输入活动的最大人数"
                                       autocomplete="off" class="layui-input" value="{{$activity->sign_up_ple_max}}">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="pay_money" required lay-verify="required" placeholder="收取报名的费用"
                                       autocomplete="off" class="layui-input" value="{{$activity->pay_money}}">
                            </div>
                        </div>
                        <div class="layui-form-item">
...
<script type="text/javascript">
    ...
    layui.use(['form', 'jquery', 'laydate', 'tool', 'element', 'upload','layedit'], function () {
        ...
        laydate.render({
            ...
            ,value: new Date({{$activity->start_time}}*1000)
        });
        ...
        laydate.render({
            ...
            , type: 'datetime'
            , format: 'yyyy-MM-dd HH:mm:ss'
            ,value: new Date({{$activity->end_time}}*1000)
        });
        //全选
